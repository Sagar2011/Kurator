...
public class Document {
    ...
    private HashSet<String> userRating;//average of the ratings given to the document by users
    ...
    //stage the document is in the system
    ...
    public Document(String _id, UUID documentId, String title, String url, String description, HashSet<String> userRating, ArrayList<String> numberOfViews, Type documentType, ArrayList<String> favouriteOf, String addedBy, LocalDateTime addedOn, String updatedBy, LocalDateTime updatedOn, HashMap<String,Integer> intent, HashMap<String,Integer> concepts, ArrayList<String> termTags, Visibility visibility, ArrayList<Flag> documentFlag, Status status) {
        this._id = _id;
        ...
        this.conceptTags = termTags;
        this.visibility = visibility;
        this.documentFlag = documentFlag;
        this.status = status;
//        this.ocumentStatus = documentStatus;
    }
